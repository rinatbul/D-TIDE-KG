...
export const WorkPackagesPageSection = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-y-18 gap-x-18 justify-items-center">
      {workPackages.map((wp) => (
        <Link key={wp.id} to={wp.link} className="bg-white w-125.5 h-107.5 rounded-[0.625rem] overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[0px_0px_25.1px_0px_rgba(0,0,0,0.25)] block no-underline">
