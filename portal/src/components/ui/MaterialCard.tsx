    ...
    <div className="bg-white rounded-[10px] border border-gray-border overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[0px_0px_12px_0px_rgba(0,0,0,0.25)]">
      ...
      <div className="p-4">
        <div className="flex items-center gap-3 mb-3">
          <img src={formatIcon} alt={material.format} className="w-[51px] h-[51px] object-contain shrink-0" />
          <h3 className="font-onest font-bold text-base leading-none text-black">{material.title}</h3>
        </div>
        <p className="font-onest font-normal text-sm leading-normal text-black mb-4">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <ExternalLink className="w-4 h-4 text-[#0052B4]" />
          </button>
          <button
          ...
          >
            ...
            <Download className="w-4 h-4 text-[#0052B4]" />
          </button>
        </div>
      </div>
    </div>
